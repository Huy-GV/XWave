...
namespace XWave.Web.Data.Migrations
{
    ...
    [Migration("20211231041029_Discount_CreatorManager")]
    partial class Discount_CreatorManager
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XWave.Models.Activity", b =>
                {
                    ...
                    b.Property<string>("CreatingManagerID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("XWave.Models.StaffActivityLog", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("XWave.Models.Activity", b =>
                {
                    b.HasOne("XWave.Models.ApplicationUser", "CreatingManager")
                        .WithMany()
                        .HasForeignKey("CreatingManagerID");

                    b.Navigation("CreatingManager");
                });
            ...
            modelBuilder.Entity("XWave.Models.StaffActivityLog", b =>
                {
                    b.HasOne("XWave.Models.Activity", "Activity")
                        .WithMany()
